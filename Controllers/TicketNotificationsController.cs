...
namespace Kanopy.Controllers
{
    ...
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var ticketNotifications = db.TicketNotifications.Include(t => t.Ticket).Include(t => t.Sender).Where(r => r.ReceipientId == userId);
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,HasBeenRead")] TicketNotification ticketNotification)
        {
